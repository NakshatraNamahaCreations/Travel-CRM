...
export const company = {
  ...
  termsAndConditions: {
    ferry: [
      'In case of ferry cancellation and schedule changes, Andaman TravelCare is not liable for any losses or wastage of time.',
      'In case private ferry tickets cannot be booked, the ticket will be transferred to Govt. ferries. Excess amount will be refunded.',
      'In case no Govt. ferries are available for the tour dates, the tour will be rescheduled based on convenience and the amount paid.',
    ],
    travelingSafety: [
      'All tests and procedures necessary before, during, and post travel must be carried out by the traveller as per Govt. rules.',
      'Cost of safety procedures are not included in the itinerary and shall be paid by the traveller directly.',
      'In case of any damage, personal or otherwise, Andaman TravelCare will not take any responsibility.',
    ],
    paymentsRefunds: [
      'All refunds will be provided in case of tour cancellation. A cancellation charge of ₹1000/- is to be paid on trip cancellation.',
      'The refund will only be initiated when Andaman TravelCare receives a full refund from the providers.',
      'In case of partial refund from providers, the same amount will be refunded to the traveller.',
    ],
  },
